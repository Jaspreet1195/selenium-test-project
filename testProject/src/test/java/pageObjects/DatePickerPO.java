...
public class DatePickerPO extends BasePage{
	...
	private WebElement checkYearRangeHeader;
	 ...
	 public WebElement getSelectYear(int year) {		
			return (driver.findElement(By.xpath("//div[@class='datepicker-years']//td//span[contains(text(),'"+year+"')]")));
		}
	...
	public WebElement getSelectMonth(String text) {		
		return (driver.findElement(By.xpath("//div[@class='datepicker-months']//td//span[contains(text(),'"+text+"')]")));
	}
	...
	public WebElement getSelectDay(String text) {		
		return (driver.findElement(By.xpath("//div[@class='datepicker-days']//td[contains(text(),'"+text+"')]")));
	}
