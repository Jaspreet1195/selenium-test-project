...
public class HomePagePO extends BasePage {
  ...
  public WebElement getLoginPortalHeader() {
    return loginPortalHeader;
  }

  public WebElement getButtonClicksHeader() {
    return buttonClicksHeader;
  }

  public WebElement getToDoListHeader() {
    return toDoListHeader;
  }

  public WebElement getPageObjectModelHeader() {
    return pageObjectModelHeader;
  }

  public WebElement getDropdownCheckboxesHeader() {
    return dropdownCheckboxesHeader;
  }

  public WebElement getAjaxLoaderHeader() {
    return ajaxLoaderHeader;
  }
  ...
  public WebElement getScrollingHeader() {
    return scrollingHeader;
  }

  public WebElement getPopupAlertsHeader() {
    return popupAlertsHeader;
  }

  public WebElement getIframeHeader() {
    return iframeHeader;
  }

  public WebElement getHiddenElementsHeader() {
    return hiddenElementsHeader;
  }

  public WebElement getDataTableHeader() {
    return dataTableHeader;
  }

  public WebElement getAutocompleteHeader() {
